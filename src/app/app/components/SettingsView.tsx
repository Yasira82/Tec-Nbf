...
// A proper app Settings page for NBF (modeled on tec-assets' settings): sectioned,
// with a Profile card, an EN/AR language toggle that drives i18n + RTL, an About
// block, and logout. (NBF has no referral loop — no invite card.) Fully translated.
  ...
  return (
    <div>
      ...
      <Section title={s.about} icon="ℹ️">
        ...
        <Row label={s.domain}><span style={{ color: TEC_COLORS.subtext, fontSize: 14 }}>nbf.pi</span></Row>
